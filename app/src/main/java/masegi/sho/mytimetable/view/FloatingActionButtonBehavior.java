package masegi.sho.mytimetable.view;
...
/**
 * Created by masegi on 2017/11/20.
 */
...
public class FloatingActionButtonBehavior extends CoordinatorLayout.Behavior {
    ...
    public boolean onDependentViewChanged(CoordinatorLayout parent, View child, View dependency) {
        ...
        if ((child instanceof FloatingActionButton || child instanceof FloatingActionMenu)
    ...
    public void onDependentViewRemoved(CoordinatorLayout parent, View child, View dependency) {
        ...
        if ((child instanceof FloatingActionButton || child instanceof FloatingActionButton)
                && dependency instanceof Snackbar.SnackbarLayout) {
